...
INSTALLED_APPS = [
    ...
    'dota2_turbo.player.apps.PlayerConfig',
]
...
TEMPLATES = [
    {
        ...
        'DIRS': [BASE_DIR / 'dota2_turbo/templates/'],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
SOCIAL_AUTH_USER_MODEL = 'dota2_turbo_authentication.SteamUser'
...
SOCIAL_AUTH_PIPELINE = (
    ...
    'dota2_turbo.authentication.pipeline.associate_existing_user',
    ...
    'dota2_turbo.authentication.pipeline.get_username',
